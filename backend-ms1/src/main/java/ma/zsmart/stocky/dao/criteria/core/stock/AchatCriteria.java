...
public class AchatCriteria extends  BaseCriteria  {
    ...
    private String tauxTvaMin;
    private String tauxTvaMax;
    ...
    public String getTauxTvaMin(){
        return this.tauxTvaMin;
    }
    public void setTauxTvaMin(String tauxTvaMin){
        this.tauxTvaMin = tauxTvaMin;
    }
    public String getTauxTvaMax(){
        return this.tauxTvaMax;
    }
    public void setTauxTvaMax(String tauxTvaMax){
        this.tauxTvaMax = tauxTvaMax;
    }
