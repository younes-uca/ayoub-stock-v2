...
public class TypeInstrumentRestAdmin  extends AbstractController<TypeInstrument, TypeInstrumentDto, TypeInstrumentCriteria, TypeInstrumentAdminService, TypeInstrumentConverter> {
    ...
    @Operation(summary = "Finds a typeInstrument by code")
    @GetMapping("code/{code}")
    public ResponseEntity<TypeInstrumentDto> findByCode(@PathVariable String code, String[] includes, String[] excludes) throws Exception {
        return super.findByReferenceEntity(new TypeInstrument(code), includes, excludes);
    }
