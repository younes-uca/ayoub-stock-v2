...
import ma.zsmart.stocky.ws.converter.commun.EtatVenteConverter;
import ma.zsmart.stocky.ws.converter.stock.AvoirVenteItemConverter;
...
import ma.zsmart.stocky.ws.converter.stock.VenteItemConverter;
import ma.zsmart.stocky.ws.converter.commun.ClientConverter;
...
public class VenteConverter extends AbstractConverter<Vente, VenteDto> {
    ...
    public Vente toItem(VenteDto dto) {
        ...
        Vente item = new Vente();
            ...
            if(StringUtil.isNotEmpty(dto.getTauxTva()))
                item.setTauxTva(dto.getTauxTva());
    ...
    public VenteDto toDto(Vente item) {
        if (item == null) {
            ...
            if(StringUtil.isNotEmpty(item.getTauxTva()))
                dto.setTauxTva(item.getTauxTva());
