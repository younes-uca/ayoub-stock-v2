...
export class ChequeEffetCreateAdminComponent extends AbstractCreateController<ChequeEffetDto, ChequeEffetCriteria, ChequeEffetAdminService>  implements OnInit {
   ...
   private _validChequeEffetBeneficiaire = true;
    ...
    public setValidation(value: boolean){
        ...
        this.validChequeEffetBeneficiaire = value;
    }
    ...
    public validateForm(): void{
        ...
        this.validateChequeEffetBeneficiaire();
    }
    ...
    public validateChequeEffetBeneficiaire(){
        if (this.stringUtilService.isEmpty(this.item.beneficiaire)) {
        this.errorMessages.push('Beneficiaire non valide');
        this.validChequeEffetBeneficiaire = false;
        } else {
            this.validChequeEffetBeneficiaire = true;
        }
    }
    ...
    get validChequeEffetBeneficiaire(): boolean {
        return this._validChequeEffetBeneficiaire;
    }

    set validChequeEffetBeneficiaire(value: boolean) {
         this._validChequeEffetBeneficiaire = value;
    }
