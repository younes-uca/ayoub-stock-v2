...
export class PaiementAvoirAchatEditAdminComponent extends AbstractEditController<PaiementAvoirAchatDto, PaiementAvoirAchatCriteria, PaiementAvoirAchatAdminService>   implements OnInit {
    ...
    private _validPaiementAvoirAchatAchat = true;
    private _validPaiementAvoirAchatModePaiement = true;
    private _validPaiementAvoirAchatAvoirAchat = true;

    private _validAchatEntrepriseSociete = true;
    ...
    constructor( private paiementAvoirAchatService: PaiementAvoirAchatAdminService , private achatService: AchatAdminService, private avoirAchatService: AvoirAchatAdminService, private modePaiementService: ModePaiementAdminService) {
    ...
    public setValidation(value: boolean){
        ...
        this.validPaiementAvoirAchatAchat = value;
        this.validPaiementAvoirAchatModePaiement = value;
        this.validPaiementAvoirAchatAvoirAchat = value;
        }
    public validateForm(): void{
        ...
        this.validatePaiementAvoirAchatAchat();
        this.validatePaiementAvoirAchatModePaiement();
        this.validatePaiementAvoirAchatAvoirAchat();
    }
    ...
    public validatePaiementAvoirAchatAchat(){
        if (this.stringUtilService.isEmpty(this.item.achat)) {
            this.errorMessages.push('Achat non valide');
            this.validPaiementAvoirAchatAchat = false;
        } else {
            this.validPaiementAvoirAchatAchat = true;
        }
    }
    ...
    public validatePaiementAvoirAchatAvoirAchat(){
        if (this.stringUtilService.isEmpty(this.item.avoirAchat)) {
            this.errorMessages.push('Avoir achat non valide');
            this.validPaiementAvoirAchatAvoirAchat = false;
        } else {
            this.validPaiementAvoirAchatAvoirAchat = true;
        }
    }
  ...
  set createModePaiementDialog(value: boolean) {
    ...
    get validPaiementAvoirAchatAchat(): boolean {
        return this._validPaiementAvoirAchatAchat;
    }
    set validPaiementAvoirAchatAchat(value: boolean) {
        this._validPaiementAvoirAchatAchat = value;
    }
    ...
    get validPaiementAvoirAchatAvoirAchat(): boolean {
        return this._validPaiementAvoirAchatAvoirAchat;
    }
    set validPaiementAvoirAchatAvoirAchat(value: boolean) {
        this._validPaiementAvoirAchatAvoirAchat = value;
    }

    get validAchatEntrepriseSociete(): boolean {
        return this._validAchatEntrepriseSociete;
    }
    set validAchatEntrepriseSociete(value: boolean) {
        this._validAchatEntrepriseSociete = value;
    }
