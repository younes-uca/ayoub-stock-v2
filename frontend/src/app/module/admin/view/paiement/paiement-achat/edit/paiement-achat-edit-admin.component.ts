...
export class PaiementAchatEditAdminComponent extends AbstractEditController<PaiementAchatDto, PaiementAchatCriteria, PaiementAchatAdminService>   implements OnInit {
    ...
    private _validPaiementAchatAchat = true;
    ...
    constructor( private paiementAchatService: PaiementAchatAdminService , private achatService: AchatAdminService, private modePaiementService: ModePaiementAdminService) {
    ...
    public setValidation(value: boolean){
        ...
        this.validPaiementAchatAchat = value;
    ...
    public validateForm(): void{
        ...
        this.validatePaiementAchatAchat();
    ...
    public validatePaiementAchatAchat(){
        if (this.stringUtilService.isEmpty(this.item.achat)) {
            this.errorMessages.push('Achat non valide');
            this.validPaiementAchatAchat = false;
        } else {
            this.validPaiementAchatAchat = true;
        }
    }
  ...
  set createModePaiementDialog(value: boolean) {
    ...
    get validPaiementAchatAchat(): boolean {
        return this._validPaiementAchatAchat;
    }
    set validPaiementAchatAchat(value: boolean) {
        this._validPaiementAchatAchat = value;
    }
