...
export class InstrumentEditAdminComponent extends AbstractEditController<InstrumentDto, InstrumentCriteria, InstrumentAdminService>   implements OnInit {
    ...
    constructor( private instrumentService: InstrumentAdminService , private typeInstrumentService: TypeInstrumentAdminService, private chequeEffetService: ChequeEffetAdminService) {
