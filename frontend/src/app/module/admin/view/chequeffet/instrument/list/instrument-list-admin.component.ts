...
export class InstrumentListAdminComponent extends AbstractListController<InstrumentDto, InstrumentCriteria, InstrumentAdminService>  implements OnInit {
    ...
    public initCol() {
        this.cols = [
            {field: 'typeInstrument?.code', header: 'Type instrument'},
   ...
   public prepareColumnExport(): void {
        this.exportData = this.items.map(e => {
            return {
                'Type instrument': e.typeInstrument?.code ,
        ...
        this.criteriaData = [{
        //'Type instrument': this.criteria.typeInstrument?.code ? this.criteria.typeInstrument?.code : environment.emptyForExport ,
