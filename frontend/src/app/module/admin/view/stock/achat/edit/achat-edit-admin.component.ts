...
export class AchatEditAdminComponent extends AbstractEditController<AchatDto, AchatCriteria, AchatAdminService>   implements OnInit {
    ...
    private _validAchatItemsPrixUttc = true;
    ...
    constructor( private achatService: AchatAdminService , private depotService: DepotAdminService, private achatItemService: AchatItemAdminService, private produitService: ProduitAdminService, private fournisseurService: FournisseurAdminService, private entrepriseSocieteService: EntrepriseSocieteAdminService, private etatAchatService: EtatAchatAdminService, private avoirAchatService: AvoirAchatAdminService) {
        super(achatService);
    }
    ...
    public validateAchatItems(){
        ...
        this.validateAchatItemsPrixUttc();
    }
    ...
    public setValidation(value: boolean){
        this.validAchatEntrepriseSociete = value;
        ...
        this.validAchatItemsPrixUttc = value;
   ...
   public addAvoirs() {
    ...
    private validateAchatItemsPrixUttc(){
        if (this.achatItemsElement.prixUttc == null) {
        this.errorMessages.push('PrixUttc de la achatItem est  invalide');
            this.validAchatItemsPrixUttc = false;
        } else {
            this.validAchatItemsPrixUttc = true;
        }
    }
  ...
  set createFournisseurDialog(value: boolean) {
    ...
    get validAchatItemsPrixUttc(): boolean {
        return this._validAchatItemsPrixUttc;
    }
    set validAchatItemsPrixUttc(value: boolean) {
        this._validAchatItemsPrixUttc = value;
    }
