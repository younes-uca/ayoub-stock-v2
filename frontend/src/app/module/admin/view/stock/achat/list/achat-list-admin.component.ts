...
export class AchatListAdminComponent extends AbstractListController<AchatDto, AchatCriteria, AchatAdminService>  implements OnInit {
    ...
    public async loadFournisseur(){
       this.fournisseurService.findAll().subscribe(fournisseurs => this.fournisseurs = fournisseurs, error => console.log(error))
    }
   ...
   public prepareColumnExport(): void {
        ...
        //'Fournisseur': this.criteria.fournisseur?.id ? this.criteria.fournisseur?.id : environment.emptyForExport ,
        //'Etat achat': this.criteria.etatAchat?.libelle ? this.criteria.etatAchat?.libelle : environment.emptyForExport ,
            ...
            'Taux tva Min': this.criteria.tauxTvaMin ? this.criteria.tauxTvaMin : environment.emptyForExport ,
            'Taux tva Max': this.criteria.tauxTvaMax ? this.criteria.tauxTvaMax : environment.emptyForExport ,
