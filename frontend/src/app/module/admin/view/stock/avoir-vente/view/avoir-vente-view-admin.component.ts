...
export class AvoirVenteViewAdminComponent extends AbstractViewController<AvoirVenteDto, AvoirVenteCriteria, AvoirVenteAdminService> implements OnInit {
    ...
    constructor(private avoirVenteService: AvoirVenteAdminService, private venteService: VenteAdminService, private depotService: DepotAdminService, private produitService: ProduitAdminService, private avoirVenteItemService: AvoirVenteItemAdminService, private entrepriseSocieteService: EntrepriseSocieteAdminService){
