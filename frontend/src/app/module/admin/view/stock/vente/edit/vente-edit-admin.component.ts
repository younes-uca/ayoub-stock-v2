...
export class VenteEditAdminComponent extends AbstractEditController<VenteDto, VenteCriteria, VenteAdminService>   implements OnInit {
    ...
    private _validVenteItemsPrixUttc = true;
    ...
    public validateVenteItems(){
        ...
        this.validateVenteItemsPrixUttc();
    ...
    public setValidation(value: boolean){
        ...
        this.validVenteItemsPrixUttc = value;
   ...
   public addAvoirs() {
    ...
    private validateVenteItemsPrixUttc(){
        if (this.venteItemsElement.prixUttc == null) {
        this.errorMessages.push('PrixUttc de la venteItem est  invalide');
            this.validVenteItemsPrixUttc = false;
        } else {
            this.validVenteItemsPrixUttc = true;
        }
    }
  ...
  set createEntrepriseSocieteDialog(value: boolean) {
    ...
    get validVenteItemsPrixUttc(): boolean {
        return this._validVenteItemsPrixUttc;
    }
    set validVenteItemsPrixUttc(value: boolean) {
        this._validVenteItemsPrixUttc = value;
    }
