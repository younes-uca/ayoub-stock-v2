...
export class AvoirAchatEditAdminComponent extends AbstractEditController<AvoirAchatDto, AvoirAchatCriteria, AvoirAchatAdminService>   implements OnInit {
    ...
    constructor( private avoirAchatService: AvoirAchatAdminService , private depotService: DepotAdminService, private produitService: ProduitAdminService, private achatService: AchatAdminService, private entrepriseSocieteService: EntrepriseSocieteAdminService, private avoirAchatItemService: AvoirAchatItemAdminService) {
