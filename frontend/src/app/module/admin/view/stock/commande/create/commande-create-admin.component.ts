...
export class CommandeCreateAdminComponent extends AbstractCreateController<CommandeDto, CommandeCriteria, CommandeAdminService>  implements OnInit {
   ...
   private _validCommandeFournisseur = true;
    ...
    constructor( private commandeService: CommandeAdminService , private etatCommandeService: EtatCommandeAdminService, private produitService: ProduitAdminService, private fournisseurService: FournisseurAdminService, private commandeItemService: CommandeItemAdminService, private entrepriseSocieteService: EntrepriseSocieteAdminService) {
    ...
    public setValidation(value: boolean){
        this.validCommandeEntrepriseSociete = value;
        this.validCommandeFournisseur = value;
    ...
    public validateForm(): void{
        ...
        this.validateCommandeEntrepriseSociete();
        this.validateCommandeFournisseur();
    }

    public validateCommandeEntrepriseSociete(){
        if (this.stringUtilService.isEmpty(this.item.entrepriseSociete)) {
        this.errorMessages.push('Entreprise societe non valide');
        this.validCommandeEntrepriseSociete = false;
        } else {
            this.validCommandeEntrepriseSociete = true;
        }
    }
    public validateCommandeFournisseur(){
        if (this.stringUtilService.isEmpty(this.item.fournisseur)) {
        this.errorMessages.push('Fournisseur non valide');
        this.validCommandeFournisseur = false;
        } else {
            this.validCommandeFournisseur = true;
        }
    }
