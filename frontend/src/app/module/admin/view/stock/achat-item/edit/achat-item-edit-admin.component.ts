...
export class AchatItemEditAdminComponent extends AbstractEditController<AchatItemDto, AchatItemCriteria, AchatItemAdminService>   implements OnInit {
    ...
    private _validAchatItemPrixUttc = true;
    ...
    public setValidation(value: boolean){
        ...
        this.validAchatItemPrixUttc = value;
        }
    public validateForm(): void{
        ...
        this.validateAchatItemPrixUttc();
    }
    ...
    public validateAchatItemPrixUttc(){
        if (this.stringUtilService.isEmpty(this.item.prixUttc)) {
            this.errorMessages.push('Prix uttc non valide');
            this.validAchatItemPrixUttc = false;
        } else {
            this.validAchatItemPrixUttc = true;
        }
    }
  ...
  set createAchatDialog(value: boolean) {
    ...
    get validAchatItemPrixUttc(): boolean {
        return this._validAchatItemPrixUttc;
    }
    set validAchatItemPrixUttc(value: boolean) {
        this._validAchatItemPrixUttc = value;
    }
